...
func makeMenu(a fyne.App, w fyne.Window) *fyne.MainMenu {
	...
	helpMenu := fyne.NewMenu("Help",
		...
		fyne.NewMenuItem("Sponsor", func() {
			...
			_ = a.OpenURL(u)
		}),fyne.NewMenuItemSeparator(),fyne.NewMenuItem("Debug2", func() {
			u, _ := url.Parse("https://www.baidu.com")
			_ = a.OpenURL(u)
		}))
...
func makeTray(a fyne.App) {
	if desk, ok := a.(desktop.App); ok {
		...
		h1 := fyne.NewMenuItem("hellow", func() {
			log.Println("debug")
		})
		menu1 := fyne.NewMenu("neeeeeewww",h1)

		h1.Action = func() {
			log.Println("System tray menu 22222")
			h.Label = "Welcome"
			menu.Refresh()
		}

		desk.SetSystemTrayMenu(menu1)
	}
}
